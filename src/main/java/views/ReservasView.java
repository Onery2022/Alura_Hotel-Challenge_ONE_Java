	...
	public ReservasView() {
		...
		txtFechaSalida.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				...
				//codigo para calcular el total de la reserva
				/**
				 * Método para calcular el valor de la reserva segun las fechas seleccionadas.
				 */
				if(txtFechaEntrada.isEnabled() && txtFechaSalida.isEnabled() && txtFechaSalida.getDate() != null){
					Date fechaEntrada = (Date) txtFechaEntrada.getDate();
					Date fechaSalida = (Date)txtFechaSalida.getDate();

					valorReserva = hotelAluraGeneralController.TotalPagar(fechaEntrada,fechaSalida);// envio de los datos a evaluar

					txtValor.setText(String.valueOf("L " + valorReserva));
				}
		...
		//Parte del codigo importante donde mandan los datos de la reserva a la base de datos
		...
		btnsiguiente.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null) {
					...
					java.sql.Date fechaFalida = new java.sql.Date(txtFechaSalida.getDate().getTime());
					String FormaPago = (String) txtFormaPago.getSelectedItem();

					var Reservas = new Reservas(fechaEntrada,fechaFalida,valorReserva,FormaPago); //envio de los datos

					reservasController.guardarReservacion(Reservas);
