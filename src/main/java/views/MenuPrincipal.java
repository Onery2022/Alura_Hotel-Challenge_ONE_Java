...
public class MenuPrincipal extends JFrame {
	...
	HotelAluraGeneralController hotelAluraGeneralController = new HotelAluraGeneralController();
	...
	public MenuPrincipal() {
		...
		JLabel lblCopyR = new JLabel("Desarrollado por Nery Orellana © 2023");
		...
		btnexit.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				hotelAluraGeneralController.ExitConfirmacion(dato);
