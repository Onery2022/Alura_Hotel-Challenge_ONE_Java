...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped() {
		...
		Integer IdReserva = reservasController.llamadoNumeroReferencia();
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String Nacionalidad = (String) txtNacionalidad.getSelectedItem();
					if(txtNombre.getText().isEmpty() || txtApellido.getText().isEmpty() || txtTelefono.getText().isEmpty() || txtNreserva.getText().isEmpty()){
						JOptionPane.showInternalMessageDialog(null, "Rellenar todos los Campos Solicitados", "Hotel Alura información", JOptionPane.INFORMATION_MESSAGE);
					}else{
						var Huespedes = new Huespedes(txtNombre.getText(),txtApellido.getText(),fechaNacimiento,Nacionalidad,Integer.valueOf(txtTelefono.getText()));
						huespedesController.guardarHuespedesController(Huespedes,Integer.valueOf(txtNreserva.getText()));
