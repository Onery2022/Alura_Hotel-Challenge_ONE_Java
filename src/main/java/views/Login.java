...
import controller.UsuariosHotelController;
...
public class Login extends JFrame {
	...
	UsuariosHotelController usuariosHotelController= new UsuariosHotelController();
	...
	private void Login() {
	        ...
	        if(txtUsuario.getText().isEmpty() || txtContrasena.getText().isEmpty()){
				JOptionPane.showMessageDialog(this, "Ingrese la informacion Solicitada");
	        }else {
				if(usuariosHotelController.AutenticacionLogin(txtUsuario.getText(),contrase)){
